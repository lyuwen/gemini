...
%
%% With gemini one can specify the following colors 
%% and the color scheme will be generated with these colors
\definecolor{accentcolor}{RGB}{62, 138, 189}
% \definecolor{textcolor}{0, 0, 0}
% \definecolor{bgcolor}{RGB}{255, 255, 255}
%
%% Additionally the following colors can also be defined
